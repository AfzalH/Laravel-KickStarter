...
<head>
    ...
    <title>Srizon KickStarter</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/')}}" class="logo">
            ...
            <span class="logo-lg"><b>Srizon</b>KickStarter</span>
        </a>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="{{\Gravatar::get('tamzida.du@gmail.com')}}" class="img-circle"
                                                     alt="User Image">
                                            </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    @else
                        ...
                        <li><a href="{{ route('super.permission.index') }}"><i
                                        class="fa fa-key"></i><span>Permissions</span></a>
                        </li>
                        @endcan
                    @endif
                </ul>
